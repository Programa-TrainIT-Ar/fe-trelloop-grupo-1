        ...
        <nav className="w-full mx-auto mb-8">
            <div className="relative flex h-16 items-center justify-between gap-4">
                ...
                <div className="flex flex-1 min-w-0 items-center gap-4">
                    ...
                    <button type="button" className="flex-shrink-0 size-12 flex items-center justify-center text-white hover:bg-[--global-color-neutral-700] rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-[--global-color-neutral-800]">
