...
export default function SideNav() {
    return (
        <div className="flex h-full flex-col border-r-[1px] border-r-[--global-color-neutral-700]">
            <Link className="bg-[--global-color-neutral-800] flex items-end justify-start p-4 md:h-40" href=''>
            ...
            <div className="flex flex-grow justify-between space-x-2 md:flex-col md:space-x-0">
                <NavLinks />
                <div className="hidden h-auto w-full grow bg-[--global-color-neutral-800] md:block"></div>
            </div>
        </div>
    )
}