            ...
            >
              <div>
                <label htmlFor="firstName" className="label-register">
                  Nombres
                  <span style={{ color: "var(--global-color-primary-500)" }}>*</span>
                </label>
                <input
                  type="text"
                  id="firstName"
                ...
                <div className="relative">
                  ...
                  >
                    {mostrar ? (
                      ...
                      <i className="fa-solid fa-eye-slash fa-swap-opacity"></i>
                    )}
                  </button>
                </div>
              ...
              <div className="col-span-2">
                ...
                <div className="text-register">
                  <p className="font-light text-center text-[16px] mt-3">
                    ...
                    <Link
                      href="#"
                      style={{ color: "var(--global-color-secondary-500)" }}
                    >
